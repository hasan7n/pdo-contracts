...
def _setup_context(state, user, context_file=None):
    ...
    context = Context(state, prefix=f"identity.{label}.rego_policy_agent")
    return context
...
def _invoke_rego_policy_agent(state, contract_id, user, cmd_class, **cmd_args):
    # setup context
...
def register_trusted_issuer(state, contract_id, issuer_contract_id, user, **cmd_args):
    ...
    return _invoke_rego_policy_agent(
...
def set_rego_policy(state, contract_id, user, **cmd_args):
    return _invoke_rego_policy_agent(
        state, contract_id, user, cmd_set_rego_policy, **cmd_args
    )


def get_rego_policy(state, contract_id, user, **cmd_args):
    return _invoke_rego_policy_agent(
        state, contract_id, user, cmd_get_rego_policy, **cmd_args
    )
...
def create_rego_policy_agent(state, user, custom_context_file=None, **cmd_args):
    # setup context
    context = _setup_context(state, user, custom_context_file)

    # run
    save_file = pcommand.invoke_contract_cmd(
        cmd_create_rego_policy_agent, state, context, **cmd_args
    )

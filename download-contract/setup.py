...
setup(
    ...
    description="Support functions PDO download contracts",
    author="Mic Bowman, Intel Labs",
    author_email="mic.bowman@intel.com",
    url="http://www.intel.com",
    package_dir={
        "pdo": "pdo",
        "pdo.download.resources.etc": "etc",
        "pdo.download.resources.context": "context",
        "pdo.download.resources.contracts": "../build/download-contract",
        "pdo.download.resources.scripts": "scripts",
    },
    packages=[
        "pdo",
        "pdo.download",
        ...
        "pdo.download.resources.contracts",
        "pdo.download.resources.scripts",
    ],

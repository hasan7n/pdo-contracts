...
setup(
    ...
    description="Support functions PDO rego contracts",
    author="Mic Bowman, Intel Labs",
    author_email="mic.bowman@intel.com",
    url="http://www.intel.com",
    package_dir={
        "pdo": "pdo",
        "pdo.rego.resources.etc": "etc",
        "pdo.rego.resources.context": "context",
        "pdo.rego.resources.contracts": "../build/rego-contract",
        "pdo.rego.resources.scripts": "scripts",
    },
    packages=[
        "pdo",
        "pdo.rego",
        ...
        "pdo.rego.scripts",
        "pdo.rego.operations",
        "pdo.rego.decentralized",
        "pdo.rego.resources",
        "pdo.rego.resources.etc",
        "pdo.rego.resources.context",
        "pdo.rego.resources.contracts",
        "pdo.rego.resources.scripts",
    ],
    ...
    entry_points={
        "console_scripts": [
            "rego_token=pdo.rego.scripts.scripts:rego_token",
            "rego_policy_agent=pdo.rego.scripts.scripts:rego_policy_agent",
            "rego_evaluator=pdo.rego.scripts.scripts:rego_evaluator",
